...
const phaseCardStyles = {
  orange: { border: "border-[#e26600]", accent: "bg-[#e26600]" },
  green: { border: "border-[#10b981]", accent: "bg-[#10b981]" },
  blue: { border: "border-[#0e42b1]", accent: "bg-[#0e42b1]" },
  violet: { border: "border-[#072056]", accent: "bg-[#072056]" },
} as const;
