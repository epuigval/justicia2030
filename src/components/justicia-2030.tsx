...
import { WorkshopEmail } from "./workshop-email";
...
export function Justicia2030() {
  ...
  return (
    <section aria-labelledby="justicia-title">
      ...
      <p className="mt-3 max-w-3xl text-lg leading-8 text-slate-650">Todas las tarjetas seleccionadas tienen el mismo peso. Completa las fases para enviar el resultado del workshop por correo.</p>
      ...
      ) : <p className="mt-6 rounded-2xl bg-emerald-50 p-5 font-bold text-emerald-950">Las fases están completas. Ya puedes enviar el resultado.</p>}
      <WorkshopEmail selections={selectionsByPhase} />
    </section>
  );
}
